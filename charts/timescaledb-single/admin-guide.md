...
takes a array of [VolumeProjection]s(https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#volumeprojection-v1-core),
...
If you now create a new deployment, you should something like the following in the log output of your deployment:
